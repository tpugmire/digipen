...
#define OnUpdate_								ONEVENT_INTERNAL_HELPER( EVENT_Update, RegisterOnUpdate )
#define OnEnter_								ONEVENT_INTERNAL_HELPER( EVENT_Enter, RegisterOnEnter )
#define OnExit_									ONEVENT_INTERNAL_HELPER( EVENT_Exit, RegisterOnExit )
